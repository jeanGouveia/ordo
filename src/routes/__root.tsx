 ...
 *
 * SSR: this document (and every route) is server-rendered/prerendered.
 */
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: 'theme-color', content: '#5d351f' },
      { property: 'og:type', content: 'website' },
      { property: 'og:title', content: 'ORDO' },
      { property: 'og:description', content: 'Do orçamento à entrega, tudo sob controle.' },
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              '@graph': [
                { '@type': 'WebSite', name: 'ORDO', url: '/' },
                { '@type': 'Organization', name: 'ORDO', url: '/', sameAs: [] },
              ],
            }),
          }}
        />
