...
// dev overlay, which is both what the user sees and what preview-error
...
export default defineConfig({
  ...
  resolve: {
    ...
    // React peers must share one React instance or hooks
  ...
  optimizeDeps: {
    ...
    // polyfill for node:async_hooks — a client-side async-hooks shim removes the
  ...
  build: {
    ...
    // .vite-out/client/* -> dist/ for static hosting
    outDir: '.vite-out',
    emptyOutDir: true,
  },
});
